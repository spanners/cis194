...
> drawElts :: forall b m.
>             (Monoid m, Backend b R2, TrailLike (QDiagram b R2 m),
>              Semigroup m) =>
>             Int -> [Int] -> QDiagram b R2 m
